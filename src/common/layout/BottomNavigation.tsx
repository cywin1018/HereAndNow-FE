...
const navItems = [
  ...
  { path: '/explore', icon: PlaceIcon, alt: '장소' },
...
const BottomNavigation = () => {
  ...
  return (
    <div className="fixed right-0 bottom-0 left-0 z-[500000] flex h-[110px] items-end justify-center bg-gradient-to-b from-transparent to-[rgba(0,0,0,0.4)] pb-8 backdrop-blur-[2px]">
